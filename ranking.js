...
function climbingLeaderboard(ranked, player) {
    ...
    player.forEach(element => {
        ...
        // Adding equal sign makes it compare the first element you IDIOT
       for (let i = ranked.length-1; i >= 0 ; i--) {
        ...
        console.log(`Ranked = ${ranked},--- ${element}`);
        result.push(1);   
    });
